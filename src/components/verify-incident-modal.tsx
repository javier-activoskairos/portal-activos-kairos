            ...
            {stars >= 1 && stars <= 3 && (
              <div className="animate-in fade-in-0 slide-in-from-top-1 mt-5 duration-200">
                ...
                <textarea
                  ...
                  className="border-border bg-card text-foreground placeholder:text-muted-foreground focus:border-brand w-full resize-none rounded-[13px] border p-3 text-[14px] leading-relaxed outline-none transition-colors"
                />
              </div>
            )}
